...
<img style="margin-right: 10px; width: 45%" src="{{site.baseurl}}/images/v1.jpg"> 
<img style="width: 45%" src="{{site.baseurl}}/images/v2.jpg"/> 
...
<img class="fullscreen" style="width: 800px;
        height: auto;" src="https://i.imgur.com/EExOpUk.jpg" onClick="makeFullScreen()"> 
